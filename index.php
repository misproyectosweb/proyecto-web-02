            ...
            <main class="contenido">
                ...
                <div class="carrusel" id="carrusel">
                    <div class="contenedor-imagenes multiple-items">                                                
                        <div class="items">
                            <img src="imagenes/imgVersiculo_1.jpg" alt=""/>
                            <div class="overlay"></div>
                        </div>
                        <div class="items">
                            <img src="imagenes/imgVersiculo_2.jpg" alt=""/>
                            <div class="overlay"></div>
                        </div>
                        <div class="items">
                            <img src="imagenes/imgVersiculo_3.jpg" alt=""/>
                            <div class="overlay"></div>
                        </div>
                        <div class="items">
                            <img src="imagenes/imgVersiculo_4.jpg" alt=""/>
                            <div class="overlay"></div>
                        </div>
                        <div class="items">
                            <img src="imagenes/imgVersiculo_5.jpg" alt=""/>
                            <div class="overlay"></div>
                        </div>
                        <div class="items">
                            <img src="imagenes/imgVersiculo_6.jpg" alt=""/>
                            <div class="overlay"></div>
                        </div>
                    </div>
                </div>
