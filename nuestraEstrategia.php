...
<!-- Página donde se muestra y describe la estrategia que va a implementar la iglesia Hacienda del Rey -->
...
<html lang="es">
    <head>
        ...
        <link href="estilos/nuestraEstrategia.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
